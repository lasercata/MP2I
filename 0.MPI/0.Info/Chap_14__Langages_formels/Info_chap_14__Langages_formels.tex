    ...
    \begin{indt}{\section{Grammaires non contextuelles}}
        \begin{indt}{\subsection{Définitions}}
            ...
            \begin{indt}{\subsubsection{Théorème}}
                ...
                \begin{proof}
                    $(1)$ Par le théorème de \textsc{Kleene} (\ref{2.4}, page \pageref{2.4}) et l'algorithme de complétion (algorithme \ref{alg:2}, page \pageref{alg:2}), il suffit de montrer que pour tout AFD complet $M = \lr{\Sigma, Q, q_0, F, \delta},\ \mathcal L(M)$ est algébrique.
