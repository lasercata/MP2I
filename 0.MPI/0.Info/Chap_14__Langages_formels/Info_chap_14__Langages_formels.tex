        ...
        \begin{indt}{\subsection{Langages réguliers}}
            ...
            \begin{indt}{\subsubsection{Proposition}}
                ...
                \begin{proof}
                    ...
                    \begin{indt}{$\bullet$ $e = e_1 | e_2$ : $L(e_1) = \varnothing = L(e_2)$ est impossible car $L(e) = L(e_1) \cup L(e_2)$}
                        $-$ Si $L(e_1) = \varnothing$ et $L(e_2) \neq \varnothing$ (l'autre ces est symétrique), $L(e) = L(e_2)$, et par H.I, $\exists f_2 \in \Regexp(\Sigma)\ |\ f_2$ ne contient pas $\varnothing$ et $f_2 \equiv e_2$.
            ...
            \begin{indt}{\subsubsection{Proposition}}
                \begin{emphBox}
                    ...
                    Alors $\varepsilon \in L(e) \ssi c(e) = 1$
                \end{emphBox}
