...
unlock_door()\end{lstlisting}
            ...
            \begin{indt}{\subsubsection{Modèle de calcul associé}}
                ...
                \begin{emphBox}
                    ...
                    Alors $u \in \mathcal L(M) \ssi$ il existe un chemin $q_0 \cdots q_n$ dans le graphe de $M$ avec $q_0 \in I\ |\ qu \in F$, et la concaténation des étiquettes sur ce chemin est $u$.
                \end{emphBox}
