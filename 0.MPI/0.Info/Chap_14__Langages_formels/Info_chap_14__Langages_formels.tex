...
if (x > a) {
    ...
    x = 0;\end{lstlisting}
            ...
            \begin{indt}{\subsubsection{\'Equivalence de grammaires}}
                ...
                $\bullet$ Remarque : il existe des langages algébriques tels que toute grammaire en engendre le langage est ambiguë. On parle de langage inhéremment / intrinsèquement ambigu (H.P).
        ...
        \begin{indt}{\subsection{Analyse syntaxique}}
            ...
            \begin{indt}{\subsubsection{Remarque}}
                ...
                On parle d'analyse LL(1) et il est possible de généraliser cette analyse en analyse LL($k$)n où la connaissance de $k$ symboles du mot cible sert à déterminer la règle.
