    ...
    \begin{indt}{\section{Classes de complexité}}
        \begin{indt}{\subsection{Introduction}}
            ...
            \begin{indt}{\subsubsection{Classes de complexité}}
                ...
                $\bullet$ Exemple : On considère le problème $P_{\rm sort}$ : étant donné deux tableaux de même taille $t_1$ et $t_2$, $t_2$ est-il une version tirée de $t_1$ ?
