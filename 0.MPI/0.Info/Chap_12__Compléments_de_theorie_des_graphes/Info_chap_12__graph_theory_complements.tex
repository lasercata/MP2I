            ...
            \begin{indt}{\subsubsection{Optimisation}}
                ...
                \begin{center}
                    \begin{tikzpicture}
                        ...
                        \node (h) at (.6, -1.365) [label=left:{head}, rectangle, draw] {};
                        \node (t) at (.6, -2) [label=left:{tail}, rectangle, draw] {};

                        \draw[->] (h) to (2.3, -1.365);
                        \draw[->] (t) to (7, -2) to (7, -1.365);

                        \node (s) at (.5, -.5) {};
                        \draw[->] (2.5, -.65) to [out=160, in=25] (s);
                        \draw[->] (4, -.65) to [out=160, in=25] (s);
                        \draw[->] (5.5, -.65) to [out=160, in=25] (s);
                        \draw[->] (7, -.65) to [out=160, in=25] (s);
                    \end{tikzpicture}
                \end{center}
