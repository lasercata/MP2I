...
\begin{document}
    ...
    \begin{indt}{\section{Syntaxe des formules logiques}}
        ...
        \begin{indt}{\subsection{Logique du premier ordre}}
            ...
            \begin{indt}{\subsubsection{Définition (varibles libres / liées)}}
                ...
                Une variable est dite \textit{liée} si elle n'est pas libre. Un même nom de variable peut avoir des occurences libres et des occurences liées. Dans une formule de la forme $Q\ x\ \varphi$ où $Q \in \set{\forall, \exists}$, on dit que $\varphi$ est la portée de la liaison pour $x$. Une variable est donc libre si elle admet une occurence hors de la portée de toutes les liaisons pour cette variable et une variable est liée si toutes ses occurences sont dans la portée d'une liaison pour cette variable.
            ...
            \begin{indt}{\subsubsection{Définition (\textit{substitution})}}
                ...
                Mais plutôt $\forall z,\ z = z + 1 + y$ : on renomme les occurences liées dans $\varphi$ des variables de $t$ avant de les substituer.
            \end{indt}
    ...
    \begin{indt}{\section{Sémantique de la logique propositionnelle}}
        ...
        \begin{indt}{\subsection{Vocabulaire}}
            \begin{indt}{\subsubsection{Introduction}}
                ...
                On peut définir une sémantique en choisisant $\N$ pour l'ensemble des valeurs, $c + 1$ comme interprétation de $c$, la fonction $\min$ comme interprétation de $+$, la fonction $\max$ pour $-$, et l'addition pour $\times$.
            ...
            \begin{indt}{\subsubsection{Définition (\textit{table de vérité})}}
                ...
                On représente la table de $\varphi$, de variables $x_1, \ldots, x_n$, en plaçant une colone pour chaque $x_i$ et une colone pour $\varphi$.
            ...
            \begin{indt}{\subsubsection{Exemple : table de vérité de $p \leftrightarrow q$}}
                ...
                Remarque : Ici on a considéré des colones supplémentaires pour des sous-formules pour simplfier le calcul.
            \end{indt}
