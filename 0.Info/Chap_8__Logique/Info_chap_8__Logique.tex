...
\begin{document}
    ...
    \begin{indt}{\section{Sémantique de la logique propositionnelle}}
        ...
        \begin{indt}{\subsection{Conséquence et équivalence}}
            ...
            \begin{indt}{\subsubsection{Remarque}}
                $\bullet$ $\varphi \equiv \psi \ssi (\varphi \vDash \psi\ \text{et}\ \psi \vDash \varphi) \ssi \varphi \leftrightarrow \psi$ (d'après \ref{3.2.1})
                    ...
                    \begin{indt}{(1) Il suffit de montrer le théorème pour les FND :}
                        ...
                        où
                            \[
                                ...
                                \left\{
                                \begin{array}{ll}
                                    \neg x_{i, j} & \text{si $l_{i ,j} = x_{i ,j} \in V$}
                                    \\
