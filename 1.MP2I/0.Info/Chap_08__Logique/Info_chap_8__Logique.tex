    ...
    | _ -> failwith "Impossible"\end{lstlisting}
        ...
        \begin{indt}{\subsection{Compléments d'algorithmique}}
            ...
            \begin{indt}{\subsubsection{Modalité d'implémentation}}
                ...
                Si on dispose d'une telle manière d'énumérer les valeurs, on peut facilement traduire l'algorithme récursif en boucle \texttt{while} (tant que l'on n'a pas trouvé de solution et que l'on n'a pas parcouru toutes les valeurs, passer à la valeur suivante) ou une boucle \texttt{for} (pour $i$ de 1 au nombre de valeurs, tester la valeur n°$i$).
